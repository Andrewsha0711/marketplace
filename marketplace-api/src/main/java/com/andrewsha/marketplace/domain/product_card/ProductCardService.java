...
//        productCardDetails.getProducts()
//                .forEach(e -> productCard.addProduct(this.productService.createProduct(e, files)));
        
        for(CreateProductForm cardForm : productCardDetails.getProducts()) {
        	Product prod = this.productService.createProduct(cardForm, files);
        	productCard.addProduct(prod);
        }
    ...
    @Transactional
    public ProductCard patchProductCard(String id, UpdateProductCardForm productDetails) {
    ...
    @Transactional
    public ProductCard putProductCard(String id, UpdateProductCardForm productDetails) {
        ProductCard productCard = this.productCardRepository.findById(id)
    ...
    @Transactional
    public ProductCard putProductToProductCard(String productCardId, Product product) {
    ...
    public void deleteProductCard(String id) {
